<%@ Page Title="" Language="C#" MasterPageFile="~/Content/SLMSAdminPanel.master" AutoEventWireup="true" CodeFile="LeaveCreditsEdit.aspx.cs" Inherits="AdminPanel_LeaveCredits_LeaveCreditsEdit" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <asp:DropDownList ID="ddlEmployeeCode" runat="server" AutoPostBack="true" enabled="false" CssClass="form-control">
                </asp:DropDownList>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <asp:DropDownList ID="ddlLeaveType" runat="server" CssClass="form-control" enabled="false">
                </asp:DropDownList>
